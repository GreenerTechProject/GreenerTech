...
const FloatingNavigation: React.FC<FloatingNavigationProps> = ({ isVisible, onClose }) => {
  const navigate = useNavigate();

  const handleItemClick = (route: string) => {
    console.log(`Navigating to ${route}`);
    navigate({ to: route });
    onClose(); // Close the floating nav after navigation
  };
  ...
  return (
    <>
      ...
      {/* Floating Navigation */}
      <div className="fixed top-20 left-4 z-50 w-80 bg-white rounded-lg shadow-xl border border-gray-200 animate-slide-in">
        {/* Header */}
        ...
        <div className="p-4 space-y-2">
          ...
          >
            <div className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-100">
              <svg width="16" height="14" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_map)">
                  <path d="M7.25 19.3482L1.76367 21.5455C1.51595 21.6438 1.25 21.4635 1.25 21.1968V5.50348C1.25 5.35387 1.34216 5.21318 1.49023 5.15289L1.48926 5.15192L7.25 2.85016V19.3482ZM17.75 4.82086V21.3228L10.25 19.1783V2.67633L17.75 4.82086ZM26.2354 2.45465C26.4832 2.35581 26.75 2.53645 26.75 2.80328V18.4966C26.75 18.6449 26.6594 18.7841 26.5137 18.8453L20.75 21.149V4.65094L26.2344 2.45367L26.2354 2.45465Z" stroke="#004AB3" strokeWidth="1.5"/>
                </g>
                <defs>
            ...
            <div>
              ...
              <div className="text-xs text-gray-500">Vue cartographique</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <div className="text-sm font-medium text-gray-900">Interventions</div>
              <div className="text-xs text-gray-500">Gestion des interventions</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs text-gray-500">Génération de rapports</div>
            </div>
          </button>
        </div>
        ...
        <div className="border-t border-gray-200 p-4">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            />
            <div>
              <div className="text-sm font-medium text-gray-900">Mohamed Samir</div>
              <div className="text-xs text-gray-500">Technicien 1</div>
            </div>
          </div>
          ...
          >
            <svg width="16" height="16" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M10.4166 3.125L9.72646 3.36858C7.04024 4.31667 5.69713 4.79071 4.93188 5.87231C4.16663 6.95392 4.16663 8.37823 4.16663 11.2269V13.7731C4.16663 16.6218 4.16663 18.046 4.93188 19.1277C5.69713 20.2093 7.04024 20.6833 9.72646 21.6315L10.4166 21.875" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
              <path d="M10.4166 12.5H20.8333M10.4166 12.5C10.4166 11.7706 12.494 10.4078 13.0208 9.89581M10.4166 12.5C10.4166 13.2294 12.494 14.5922 13.0208 15.1041" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
