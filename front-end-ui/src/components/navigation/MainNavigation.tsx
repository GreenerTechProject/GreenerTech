  ...
  return (
    <div className="main-navigation">
      ...
      <div className="navigation-content">
        ...
        >
          <div className="nav-icon-container nav-icon-map">
          ...
          <span className="nav-label nav-label-map">Map</span>
        </button>

        {/* Surveillance Button */}
        <button
          onClick={() => handleItemClick('surveillance')}
          className="nav-item nav-item-surveillance"
        >
        ...
        <button
          ...
          className="nav-item nav-item-alertes"
        >
          <div className="nav-icon-container">
        ...
        <button
          ...
          className="nav-item nav-item-interventions"
        >
          <div className="nav-icon-container">
        ...
        <button
          ...
          className="nav-item nav-item-rapports"
        >
          <div className="nav-icon-container">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="nav-label nav-label-rapports">Rapports</span>
        </button>
