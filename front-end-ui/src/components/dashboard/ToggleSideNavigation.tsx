...
const ToggleSideNavigation: React.FC = () => {
  ...
  const navigationItems: NavigationItem[] = [
    {
      ...
      label: 'Map',
      icon: (
        <svg width="27" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <>
      ...
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="6" cy="12" r="2" fill="#6C7072"/>
          <circle cx="12" cy="12" r="2" fill="#6C7072"/>
          <circle cx="18" cy="12" r="2" fill="#6C7072"/>
        </svg>
      </button>
      ...
      {/* Side Navigation */}
      <div className={`toggle-side-navigation ${isOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
