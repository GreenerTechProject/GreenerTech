            ...
            <div className="p-6 space-y-6">
                    ...
                    >
                      <CardContent className="p-4">
                        ...
                        <div className="flex items-center justify-between text-sm text-gray-500">
                          ...
                          <span>Zones: {serre.zones.length}</span>
                        </div>
              ...
              {Array.isArray(bilans) && (
                    ...
                    {isLoadingBilans ? (
                      ...
                      <div className="text-center py-6 text-gray-500">
                        <FileText className="h-8 w-8 mx-auto mb-2 opacity-50" />
                        <p>Aucun bilan créé pour cette serre</p>
                        <p className="text-sm">Créez votre premier bilan en utilisant le bouton ci-dessus</p>
                      </div>
                    ) : (
                            <div className="space-y-2">
                        {bilans.map((bilan) => (
                            ...
                            className="p-3 border rounded-lg bg-blue-50"
                                >
                                  ...
                                  {bilan.nom}
                                      ...
                                      <p className="text-sm text-gray-600">
                                  {bilan.position && Array.isArray(bilan.position) ? bilan.position.length : 0} points GPS
                                      </p>
                                    </div>
                                    <Badge
                                      variant="outline"
                              ...
                              {bilan.surface && (
                                    <div className="flex justify-between">
                                      <span>Surface:</span>
                                  <span>{bilan.surface.toFixed(2)} m²</span>
                                      </div>
                                    )}
                                      <div className="flex justify-between">
                                <span>Points:</span>
                                <span>{bilan.position && Array.isArray(bilan.position) ? bilan.position.length : 0}/4</span>
                                      </div>
                                  </div>
                                </div>
                              ))}
                  ...
                  {bilans.length > 0 && <Separator />}
                        </>
                      )}

                      {/* Zones Section */}
              {selectedSerre && selectedSerre.zones && selectedSerre.zones.length > 0 ? (
                        <div>
                          ...
                          <Accordion
                            ...
                            className="space-y-2"
                          >
                    {selectedSerre.zones && selectedSerre.zones.map((zone) => (
                              <AccordionItem
                                key={zone.id}
                                value={zone.id}
